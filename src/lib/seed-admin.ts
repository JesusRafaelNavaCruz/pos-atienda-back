...
function parseCliArgs(): Partial<AdminData> {
...
function getEnvData(): Partial<AdminData> {
  return {
...
// Modo interactivo
async function interactiveMode(): Promise<AdminData> {
...
// Validar datos
function validateData(data: Partial<AdminData>): AdminData {
